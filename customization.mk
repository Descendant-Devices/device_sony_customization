...
PRODUCT_COPY_FILES += \
    ...
    $(CUST_PATH)/ims/qti-telephony-common.jar:$(TARGET_COPY_OUT_PRODUCT)/framework/qti-telephony-common.jar \
...
COMMON_LUNCH_CHOICES += \
    descendant_j8110-eng \
    descendant_j8110-userdebug \
    descendant_j9110-eng \
    descendant_j9110-userdebug

BUILD_BROKEN_DUP_RULES := true
$(call inherit-product, vendor/descendant/config/common_full_phone.mk)
$(call inherit-product, device/sony/customization/GApps-flags.mk)
